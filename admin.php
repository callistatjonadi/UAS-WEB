                      ...
                      <?php 
                          ...
                          if(mysqli_num_rows($result) > 0){
                            while($row_video = $result->fetch_assoc()){
                              ...
                              if (in_array($user_id, $processedUsers)) {
                                continue;
                              }
                              $processedUsers[] = $user_id;
                            ...
                            ?>
                              ...
                              <a href="admin_listvideo.php?get_id_user=<?= $user_id; ?>">  
                                <img src="media/<?=$row_user['profile']; ?>" class="card-img-top profil" alt="..." style="margin-top: 20px; margin-left: 60px;">
                              </a>
                              <div class="card-body">
                                <h5 class="card-title tengah"><?=$row_user['nama']; ?></h5>
                              </div>
                              </div>
                            <?php
                            }
