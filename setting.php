...
if(isset($_POST['save'])){
  ...
  $sql = "UPDATE student SET nama = ?, username = ? WHERE id = '$id_user'";
  $stmt = $conn->prepare($sql);
  $stmt->bind_param("ss", $nama_baru, $username_baru);
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div style="margin-left:60px; margin-top:20px;">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="nama" value=<?php echo $nama; ?> name="nama">
        </div>
      </div>
      ...
      <div style="margin-left:60px; margin-top:20px;">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="username" value=<?php echo $username; ?> name="username">
        </div>
      </div>
