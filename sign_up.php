...
if(isset($_POST['submit']) && isset($_POST['nama']) != "" && isset($_POST['username']) != "" && isset($_POST['email']) != "" && isset($_POST['nama']) != ""){
  $nama = $_POST['nama'];
...
<main class="form-signin w-100 m-auto">
  ...
  <img style="margin-left:-15px" class="mb-4 navbar-brand studee" src="gambar/studee.png" width="220" height="70">
    ...
    <p>Sudah ada akun? Ayo <a href="login.php">Masuk </a>ke akunmu </p>
